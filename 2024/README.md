...
Status for the Unit tests: [![2024 .NET 10 Xunit Tests](https://github.com/snailtail/AdventOfCode/actions/workflows/2024-tests.yml/badge.svg)](https://github.com/snailtail/AdventOfCode/actions/workflows/2024-tests.yml)  
...
I haven't studied maths and geometry and such things in \*hrm\* *"a while"*.  
...
I believe the term I found on Google was *"checking if the vectors are scalar multiples of each other"*.  
...
*Build a "Three bit computer" and run this program.*  
